        ...
        <div class="flex w-full max-w-4xl bg-blue-400 border rounded-lg overflow-hidden shadow-xl">
            ...
            <form method="POST" class="max-w-sm mx-auto">
                ...
                <div class="mt-10 mb-0">
                    ...
                    <input type="text"  name="username"  class="dark:bg-gray-200 border border-black text-sm rounded-lg block w-full p-2.5  dark:border-blue-500 dark:placeholder-gray-600 dark:text-white" placeholder="estella@gmail.com" required><br><br>
                </div>
                <div class="mb-1">
                    <label for="password" class="block mb-2 text-black text-base font-medium ">PASSWORD:</label>
                    <input type="password"  name="password"  class="dark:bg-gray-200 border border-black text-sm rounded-lg block w-full p-2.5  dark:border-blue-500 dark:placeholder-gray-600 dark:text-white" placeholder="password" required"><br><br>
                </div>
